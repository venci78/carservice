...
import com.vencislav.carserviceapp.repository.OwnerRepository;
...
public class OwnerResourceIntTest {
    ...
    public void createOwner() throws Exception {
        ...
        assertThat(testOwner.getTel()).isEqualTo(DEFAULT_TEL);
    }
    ...
    public void updateOwner() throws Exception {
        ...
        assertThat(testOwner.getTel()).isEqualTo(UPDATED_TEL);
    }
